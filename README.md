...
Ищу наблюдение-дубликат и проверяю, что он дейстивительно дубликат руками.

<img src='img/dup_example.png' width="900" height="658"/>

Ну если только это наблюдение залили 104 раза, то 54 тысячи дубликатов становится похожами на правду.
