...
Коэффициент корреляци между `year` и `price` равен **0.36**.
...
Коэффициент корреляци между `km_age` и `price` равен **-0.4**.
...
1. Новые автомобили стоят больше, чем подержанные. <span style="color:green;">Подтвердилась</span>
2. Чем больше лошадинные сил, тем больше цена. <span style="color:green;">Подтвердилась</span>
3. Премиум сегмент, дороже остальных. <span style="color:green;">Подтвердилась</span>
4. Чем больше владелецев, тем дешевле цена. <span style="color:green;">Подтвердилась</span>
5. Чем старше автомобиль, тем он дешевле. <span style="color:green;">Подтвердилась</span>
6. Чем больше пробег, тем дешевле автомобиль. <span style="color:green;">Подтвердилась</span>